...
function myCallBack() {
    ...
    req.onreadystatechange = function () {
        if (this.readyState === 4 && this.status === 200) {
            ...
            //     userEmail = JSON.stringify(objList[i].email)
            //     emailArray.push(userEmail);
            // }
            ...
            //     output += '<li style="list-style-type: none;">' + JSON.parse(emailArray[i]) + '</li>';
            // };
